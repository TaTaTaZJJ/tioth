...
static const s8 sAiAbilityRatings[ABILITIES_COUNT] =
{
    ...
    [ABILITY_FIRE_SKIN] = 8,
    [ABILITY_WATER_SKIN] = 8,
    [ABILITY_GRASS_SKIN] = 8,
    [ABILITY_PSYCHIC_SKIN] = 8,
    [ABILITY_ROCK_SKIN] = 8,
    [ABILITY_GHOST_SKIN] = 8,
    [ABILITY_FIGHTING_SKIN] = 8,
    [ABILITY_GROUND_SKIN] = 8,
    [ABILITY_STEEL_SKIN] = 8,
    [ABILITY_POISON_SKIN] = 8,
    [ABILITY_DRAGON_SKIN] = 8,
    [ABILITY_BUG_SKIN] = 8,
    [ABILITY_DARK_SKIN] = 8,
