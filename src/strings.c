...
#ifdef CHINESE
_("{CLEAR_TO 0x0C}    '    ”"); // Unused //TODO 汉化
#else
...
#ifdef CHINESE
_("You've got 9,999 COINS."); //TODO 汉化
#else
...
#ifdef CHINESE
_("You don't have three COINS."); //TODO 汉化
#else
