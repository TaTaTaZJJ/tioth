...
const u8 gText_RedPokeblock[] = _("红色能量块");
const u8 gText_BluePokeblock[] = _("蓝色能量块");
const u8 gText_PinkPokeblock[] = _("粉色能量块");
const u8 gText_GreenPokeblock[] = _("绿色能量块");
const u8 gText_YellowPokeblock[] = _("黄色能量块");
const u8 gText_PurplePokeblock[] = _("紫色能量块");
const u8 gText_IndigoPokeblock[] = _("靛蓝色能量块");
const u8 gText_BrownPokeblock[] = _("棕色能量块");
const u8 gText_LiteBluePokeblock[] = _("淡蓝色能量块");
const u8 gText_OlivePokeblock[] = _("橄榄色能量块");
const u8 gText_GrayPokeblock[] = _("灰色能量块");
const u8 gText_BlackPokeblock[] = _("黑色能量块");
const u8 gText_WhitePokeblock[] = _("白色能量块");
const u8 gText_GoldPokeblock[] = _("金色能量块");
...
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("对方训练师的宝可梦\n暂时不能交换！");
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = _("对方训练师暂时不能\n接受这个宝可梦！");
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = _("你暂时不能和那个\n训练师交换！");
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("这不是对方训练师\n想要的宝可梦种类！");
...
const u8 gText_PyramidTrainers[] = _("金字塔：训练师");
...
const u8 gText_CallRegisteredTrainer[] = _("呼叫已登记的训练师。");
...
const u8 gText_NoTrainersRegistered[] = _("没有登记训练师。"); // Unused
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("训练师的宝可梦");
...
const u8 gText_TrainerCloseBy[] = _("这个训练师就在附近！\n去和训练师谈谈吧！");
...
const u8 gText_Var1sTrainerCard[] = _("{STR_VAR_1}的训练师卡片");
...
const u8 gText_WaitingTrainerFinishReading[] = _("正在等待另一位训练师\n结束查看你的训练师卡片。");
const u8 gText_PokeblocksWithFriends[] = _("能量方块 赢/个朋友");
...
const u8 gText_CheckTrainerCard[] = _("查看训练师卡片。");
...
ALIGNED(4) const u8 gText_NewTrainerReceived[] = _("新的训练师已经到达。");
...
ALIGNED(4) const u8 gText_CantAcceptCardFromTrainer[] = _("你不能从这个训练师处接收\n神秘卡片。");
ALIGNED(4) const u8 gText_CantAcceptNewsFromTrainer[] = _("你不能从这个训练师处接收\n神秘新闻。");
...
ALIGNED(4) const u8 gText_OtherTrainerHasCard[] = _("对方训练师已有同样的神秘卡片。");
ALIGNED(4) const u8 gText_OtherTrainerHasNews[] = _("对方训练师已有同样的神秘新闻。");
ALIGNED(4) const u8 gText_OtherTrainerHasStamp[] = _("对方训练师已有同样的印章。");
ALIGNED(4) const u8 gText_OtherTrainerCanceled[] = _("对方训练师取消了通信。");
ALIGNED(4) const u8 gText_CantSendGiftToTrainer[] = _("你不能将神秘礼物送给这个训练师。");
