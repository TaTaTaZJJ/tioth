...
#ifdef CHINESE
_("{DPAD_UPDOWN}选择 {A_BUTTON}好"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}下个 {B_BUTTON}返回"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DPAD_UPDOWN}选择 {A_BUTTON}下个 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DPAD_UPDOWN}选择 {A_BUTTON}{B_BUTTON}取消"); //TODO 汉化
#else
...
const u8 gText_DexSearchAlphaABC[] = 
#ifdef CHINESE
_("ABC"); //TODO 汉化
#else
_("ABC");
...
const u8 gText_DexSearchAlphaDEF[] = 
#ifdef CHINESE
_("DEF"); //TODO 汉化
#else
_("DEF");
...
const u8 gText_DexSearchAlphaGHI[] = 
#ifdef CHINESE
_("GHI"); //TODO 汉化
#else
_("GHI");
...
const u8 gText_DexSearchAlphaJKL[] = 
#ifdef CHINESE
_("JKL"); //TODO 汉化
#else
_("JKL");
...
const u8 gText_DexSearchAlphaMNO[] = 
#ifdef CHINESE
_("MNO"); //TODO 汉化
#else
_("MNO");
...
const u8 gText_DexSearchAlphaPQR[] = 
#ifdef CHINESE
_("PQR"); //TODO 汉化
#else
_("PQR");
...
const u8 gText_DexSearchAlphaSTU[] = 
#ifdef CHINESE
_("STU"); //TODO 汉化
#else
_("STU");
...
const u8 gText_DexSearchAlphaVWX[] = 
#ifdef CHINESE
_("VWX"); //TODO 汉化
#else
_("VWX");
...
const u8 gText_DexSearchAlphaYZ[] = 
#ifdef CHINESE
_("YZ"); //TODO 汉化
#else
_("YZ");
...
#ifdef CHINESE
_("已发现的宝可梦：{STR_VAR_1}！\n已抓到的宝可梦：{STR_VAR_2}！\p小田卷博士的图鉴评价！\p小田卷博士：让我看看……\p"); //TODO 汉化
#else
...
_("老爸说过……\n{PLAYER}，每一样东西都有适合使用的时候！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
//TODO 汉化
#else
...
#ifdef CHINESE
_("你不能在这里下自行车。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("哈？\n寻宝机器有反应了！\p看来在这附近有隐藏道具！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("噢！\n寻宝机器有很强烈的反应！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("……不！\n没有任何反应。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("上一回使用的除虫喷雾器\n效果还残留着！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{PLAYER}使用了\n{STR_VAR_2}。\p野生宝可梦会被吸引。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{PLAYER}使用了\n{STR_VAR_2}。\p野生宝可梦会被驱散。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("这个箱子满了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("粉末数量：{STR_VAR_1}{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{NO}{STR_VAR_1}{CLEAR 0x07}{STR_VAR_2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{CLEAR_TO 0x11}{STR_VAR_1}{CLEAR 0x05}{STR_VAR_2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}.{STR_VAR_2}cm"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{NO}{STR_VAR_1} {STR_VAR_2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("决定买{STR_VAR_1}？购买{STR_VAR_2}个？\n你需要支付{STR_VAR_3}$。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("抱歉，你没有足够的钱。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("你没有足够的空间来装下\n这个道具了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("留给{STR_VAR_1}的空间已经满了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("赠送一个首席球作为礼品哦！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_2}吗？\n噢，抱歉，我不能买那个。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("没有任何效果。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("这个不能对\n那个宝可梦使用。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{PAUSE_UNTIL_PRESS}，宝可梦蛋不能参战！"); //TODO 汉化
#else
...
#ifdef CHINESE
_("直至得到新的徽章前\n这个不能使用。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("不超过{STR_VAR_1}宝可梦\n才能进入。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("邮件已经发送去你的电脑了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("你电脑的邮箱已经满了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("取下邮件才能\n携带道具！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("给{STR_VAR_1}\n携带了{STR_VAR_2}！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}没有携带\n任何道具！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("从{STR_VAR_1}那里\n拿到了{STR_VAR_2}！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("将宝可梦身上的邮件\n取下来了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("取回了{STR_VAR_2}\n并携带了{STR_VAR_1}。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("宝可梦已经携带了\n道具，不能再持有邮件了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("背包已经满了，宝可梦的\n道具不能放进去了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}与{STR_VAR_2}\n的相性很差，\p{STR_VAR_2}不能\n学会！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("想忘记哪个技能？{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("1，{PAUSE 15}2……{PAUSE 15}{PAUSE 15}{PAUSE 15}{PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}砰！\p{STR_VAR_1}将\n{STR_VAR_2}忘记了！\p然后……{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}将新技能\n{STR_VAR_2}记住了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}的HP回复了\n{STR_VAR_2}点。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}治愈了\n体内毒素！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}治愈了\n麻痹状态！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}醒来了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}治愈了烧伤状态！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}解除冻结了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("回复PP了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}回复体力了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}恢复健康了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}的PP上升了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}的基础{STR_VAR_2}\n上升了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}变得更加友好了\n基础{STR_VAR_2}下降了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}变得更加友好了\n但是基础{STR_VAR_2}不能再下降了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}解除了\n混乱状态！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}解除了\n着迷状态！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}\n被丢掉了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("这个宝可梦不能参加！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_OnlyPkmnForBattle[] = 
#ifdef CHINESE
_("这是你最后一个能\n战斗的宝可梦了！"); //TODO 汉化
#else
_("That's your only\nPOKéMON for battle.");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = 
#ifdef CHINESE
_("这个宝可梦暂时不能\n交换！"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = 
#ifdef CHINESE
_("蛋不能交换！"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = 
#ifdef CHINESE
_("对方训练师的宝可梦\n暂时不能交换！"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = 
#ifdef CHINESE
_("对方训练师暂时不能\n接受这个宝可梦！"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = 
#ifdef CHINESE
_("你暂时不能和那个\n训练师交换！"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = 
#ifdef CHINESE
_("这不是对方训练师\n想要的宝可梦种类！"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_ThatIsntAnEgg[] = 
#ifdef CHINESE
_("那不是宝可梦蛋！"); //TODO 汉化
#else
_("That isn't an EGG.");
...
#ifdef CHINESE
_("性格{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}，\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}时在\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}遇到。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("性格{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}，\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}时在\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}孵化。。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("性格{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}"); //TODO 汉化
#else
_("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature");
#endif
...
#ifdef CHINESE
_("性格{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}，\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}时在某处遇到。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("性格{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5}，\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}时在某处孵化。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("注册记录已被删除。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("没有任何的注册条目。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_3}{STR_VAR_1}/{STR_VAR_2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("没有装饰物。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("没有装饰物在使用中。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("没有道具。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("这里没有邮件。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("背包已经满了。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("信息已被清除\n邮件放回了背包。{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("美味的水{CLEAR_TO 0x48}200$"); //TODO 汉化
#else
...
#ifdef CHINESE
_("塞可汽水{CLEAR_TO 0x48}300$"); //TODO 汉化
#else
...
#ifdef CHINESE
_("调味乳{CLEAR_TO 0x48}350$"); //TODO 汉化
#else
...
#ifdef CHINESE
_("TM32{CLEAR_TO 0x48}1500 代币"); //TODO 汉化
#else
...
#ifdef CHINESE
_("TM29{CLEAR_TO 0x48}3500 代币"); //TODO 汉化
#else
...
#ifdef CHINESE
_("TM35{CLEAR_TO 0x48}4000 代币"); //TODO 汉化
#else
...
#ifdef CHINESE
_("TM24{CLEAR_TO 0x48}4000 代币"); //TODO 汉化
#else
...
#ifdef CHINESE
_("TM13{CLEAR_TO 0x48}4000 代币"); //TODO 汉化
#else
...
#ifdef CHINESE
_("力之粉{CLEAR_TO 0x72}{SIZE 0} 50"); //TODO 汉化
#else
...
#ifdef CHINESE
_("力之根{CLEAR_TO 0x72}{SIZE 0} 80"); //TODO 汉化
#else
...
#ifdef CHINESE
_("万能之粉{CLEAR_TO 0x72}{SIZE 0} 50"); //TODO 汉化
#else
...
#ifdef CHINESE
_("复活之草{CLEAR_TO 0x6C}{SIZE 0} 300"); //TODO 汉化
#else
...
#ifdef CHINESE
_("蛋白药剂{CLEAR_TO 0x63}{SIZE 0} 1,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补铁药剂{CLEAR_TO 0x63}{SIZE 0} 1,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补碳药剂{CLEAR_TO 0x63}{SIZE 0} 1,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补钙药剂{CLEAR_TO 0x63}{SIZE 0} 1,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补锌药剂{CLEAR_TO 0x63}{SIZE 0} 1,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("HP提升剂{CLEAR_TO 0x63}{SIZE 0} 1,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("PP提升剂{CLEAR_TO 0x63}{SIZE 0} 3,000"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}放大 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}全景 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}情报 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}标记 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}选择标记 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}菜单 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}好 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}缎带 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{A_BUTTON}查看 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DYNAMIC 0}/{LV}{DYNAMIC 1}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{DYNAMIC 0}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("亲嘴海报{CLEAR_TO 0x5E}16BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("迷唇坐垫{CLEAR_TO 0x5E}32BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("迷唇娃玩偶{CLEAR_TO 0x5E}32BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("波克比玩偶{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("喵喵玩偶{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("皮皮玩偶{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("百变怪玩偶{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("火球鼠玩偶{CLEAR_TO 0x5E}80BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("菊草叶玩偶{CLEAR_TO 0x5E}80BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("小锯鳄玩偶{CLEAR_TO 0x5E}80BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("乘龙玩偶{CLEAR_TO 0x58}128BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("卡比兽玩偶{CLEAR_TO 0x58}128BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("妙蛙花玩偶{CLEAR_TO 0x58}256BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("喷火龙玩偶{CLEAR_TO 0x58}256BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("水箭龟玩偶{CLEAR_TO 0x58}256BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("蛋白药剂{CLEAR_TO 0x64}1BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补钙药剂{CLEAR_TO 0x64}1BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补铁药剂{CLEAR_TO 0x64}1BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补锌药剂{CLEAR_TO 0x64}1BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("补碳药剂{CLEAR_TO 0x64}1BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("HP提升剂{CLEAR_TO 0x64}1BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("剩饭{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("白色药草{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("先攻之爪{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("心灵药草{CLEAR_TO 0x5E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("亮光之粉{CLEAR_TO 0x5E}64BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("守旧之钵{CLEAR_TO 0x5E}64BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("王者之证{CLEAR_TO 0x5E}64BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("精气之钵{CLEAR_TO 0x5E}64BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("对焦镜片{CLEAR_TO 0x5E}64BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("生蛋{CLEAR_TO 0x4E}16BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("地球上投{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("食梦{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("百万吨拳击{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("百万吨飞踢{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("泰山压顶{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("山崩地裂{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("返拳{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("电磁波{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("剑舞{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("防卫卷{CLEAR_TO 0x4E}16BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("打鼾{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("泥汤{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("高速星星{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("冻风{CLEAR_TO 0x4E}24BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("忍耐{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("自我暗示{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("急冻拳{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("雷光掌{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("火焰拳{CLEAR_TO 0x4E}48BP"); //TODO 汉化
#else
...
#ifdef CHINESE
_("胜/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY} 连续/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_FacilitySingle[] = 
#ifdef CHINESE
_("{STR_VAR_1}单人"); //TODO 汉化
#else
_("{STR_VAR_1} SINGLE");
#endif

ALIGNED(4) const u8 gText_FacilityDouble[] = 
#ifdef CHINESE
_("{STR_VAR_1}双人"); //TODO 汉化
#else
_("{STR_VAR_1} DOUBLE");
#endif

ALIGNED(4) const u8 gText_FacilityMulti[] = 
#ifdef CHINESE
_("{STR_VAR_1}多人"); //TODO 汉化
#else
_("{STR_VAR_1} MULTI");
#endif

ALIGNED(4) const u8 gText_FacilityLink[] = 
#ifdef CHINESE
_("{STR_VAR_1}联机"); //TODO 汉化
#else
_("{STR_VAR_1} LINK");
#endif

ALIGNED(4) const u8 gText_Facility[] = 
#ifdef CHINESE
_("{STR_VAR_1}"); //TODO 汉化
#else
_("{STR_VAR_1}");
...
#ifdef CHINESE
_("{STR_VAR_1}的{STR_VAR_2}赢了！"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR6 WHITE DYNAMIC_COLOR5}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("是否给新出生的\n{STR_VAR_1}取个名字？"); //TODO 汉化
#else
_("Would you like to nickname the newly\nhatched {STR_VAR_1}?");
#endif

ALIGNED(4) const u8 gText_ReadyPickBerry[] = 
#ifdef CHINESE
_("是否准备开始树果混合？\n请选择一个树果。\p"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WaitForAllChooseBerry[] = 
#ifdef CHINESE
_("请等待每一位\n成员选择好树果。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_EndedWithXUnitsPowder[] = 
#ifdef CHINESE
_("{PAUSE_MUSIC}{PLAY_BGM MUS_LEVEL_UP}你最终获得{STR_VAR_1}单位\n圆滑的树果粉末。{RESUME_MUSIC}\p你树果粉末的\n总数是{STR_VAR_2}。\p"); //TODO 汉化
#else
_("{PAUSE_MUSIC}{PLAY_BGM MUS_LEVEL_UP}You ended up with {STR_VAR_1} units of\nsilky-smooth BERRY POWDER.{RESUME_MUSIC}\pYour total amount of BERRY POWDER\nis {STR_VAR_2}.\p");
#endif

ALIGNED(4) const u8 gText_RecordingGameResults[] = 
#ifdef CHINESE
_("在存档中记录\n你的结果，\l请稍后。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_PlayBerryCrushAgain[] = 
#ifdef CHINESE
_("是否再来一次树果混合？"); //TODO 汉化
#else
_("Want to play BERRY CRUSH again?");
#endif

ALIGNED(4) const u8 gText_YouHaveNoBerries[] = 
#ifdef CHINESE
_("你没有树果。\n即将取消游戏。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_MemberDroppedOut[] = 
#ifdef CHINESE
_("有一位成员退出，\n即将取消游戏。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_TimesUpNoGoodPowder[] = 
#ifdef CHINESE
_("时间到。\p不能制作出好的\n树果粉末……\p"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_CommunicationStandby2[] = 
#ifdef CHINESE
_("通信等待中……"); //TODO 汉化
#else
_("Communication standby…");
...
ALIGNED(4) const u8 gText_1DotBlueF700[] = 
#ifdef CHINESE
_("1. {COLOR BLUE}[阴影色_09]{DYNAMIC 0}"); //TODO 汉化
#else
_("1. {COLOR BLUE}{SHADOW LIGHT_BLUE}{DYNAMIC 0}");
#endif

ALIGNED(4) const u8 gText_1DotF700[] = 
#ifdef CHINESE
...
ALIGNED(4) const u8 gText_SpaceTimes2[] = 
#ifdef CHINESE
_("次"); //TODO 汉化
#else
_("time(s)");
...
ALIGNED(4) const u8 gText_XDotY[] = 
#ifdef CHINESE
...
ALIGNED(4) const u8 gText_Var1Berry[] = 
#ifdef CHINESE
_("{STR_VAR_1}个树果"); //TODO 汉化
#else
_("{STR_VAR_1} BERRY");
#endif

ALIGNED(4) const u8 gText_TimeColon[] = 
#ifdef CHINESE
_("时间："); //TODO 汉化
#else
_("Time:");
...
ALIGNED(4) const u8 gText_PressingSpeed[] = 
#ifdef CHINESE
_("按键速度："); //TODO 汉化
#else
_("Pressing Speed:");
...
ALIGNED(4) const u8 gText_Silkiness[] = 
#ifdef CHINESE
_("圆滑度："); //TODO 汉化
#else
_("Silkiness:");
...
ALIGNED(4) const u8 gText_StrVar1[] = 
#ifdef CHINESE
_("{STR_VAR_1}"); //TODO 汉化
#else
_("{STR_VAR_1}");
...
ALIGNED(4) const u8 gText_SpaceMin[] = 
#ifdef CHINESE
_("分"); //TODO 汉化
#else
_("min. ");
...
ALIGNED(4) const u8 gText_XDotY2[] = 
#ifdef CHINESE
_("{STR_VAR_1}.{STR_VAR_2}"); //TODO 汉化
#else
_("{STR_VAR_1}.{STR_VAR_2}");
...
ALIGNED(4) const u8 gText_SpaceSec[] = 
#ifdef CHINESE
_("秒"); //TODO 汉化
#else
_("sec.");
...
ALIGNED(4) const u8 gText_XDotY3[] = 
#ifdef CHINESE
_("{STR_VAR_1}.{STR_VAR_2}"); //TODO 汉化
#else
_("{STR_VAR_1}.{STR_VAR_2}");
...
ALIGNED(4) const u8 gText_TimesPerSec[] = 
#ifdef CHINESE
_("次/秒"); //TODO 汉化
#else
_("Times/sec.");
...
ALIGNED(4) const u8 gText_Var1Percent[] = 
#ifdef CHINESE
_("{STR_VAR_1}%"); //TODO 汉化
#else
_("{STR_VAR_1}%");
...
ALIGNED(4) const u8 gText_PressesRankings[] = 
#ifdef CHINESE
_("键速排名No."); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_CrushingResults[] = 
#ifdef CHINESE
_("混合结果"); //TODO 汉化
#else
_("Crushing Results");
...
ALIGNED(4) const u8 gText_NeatnessRankings[] = 
#ifdef CHINESE
_("圆滑度排名"); //TODO 汉化
#else
_("Neatness Rankings");
...
ALIGNED(4) const u8 gText_CoopRankings[] = 
#ifdef CHINESE
_("协力合作排名"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_PressingPowerRankings[] = 
#ifdef CHINESE
_("按压力度排名"); //TODO 汉化
#else
...
#ifdef CHINESE
_("了不起的得分！\n你赢得了{DYNAMIC 1} {DYNAMIC 0}！"); //TODO 汉化
#else
...
#ifdef CHINESE
_("通过次数：\c\h11\h05\v\h02"); //TODO 汉化
#else
...
#ifdef CHINESE
_("通过楼层：{STR_VAR_1}"); //TODO 汉化
#else
_("Floors cleared: {STR_VAR_1}");
#endif


ALIGNED(4) const u8 gText_RecordsLv50[] = 
#ifdef CHINESE
_("50级"); //TODO 汉化
#else
_("LV. 50");
...
ALIGNED(4) const u8 gText_RecordsOpenLevel[] = 
#ifdef CHINESE
_("自由级"); //TODO 汉化
#else
_("OPEN LEVEL");
...
ALIGNED(4) const u8 gText_FrontierFacilityWinStreak[] = 
#ifdef CHINESE
_("连胜：{STR_VAR_2}"); //TODO 汉化
#else
_("Win streak: {STR_VAR_2}");
#endif

ALIGNED(4) const u8 gText_FrontierFacilityClearStreak[] = 
#ifdef CHINESE
_("连续过关：{STR_VAR_2}"); //TODO 汉化
#else
_("Clear streak: {STR_VAR_2}");
#endif

ALIGNED(4) const u8 gText_FrontierFacilityRoomsCleared[] = 
#ifdef CHINESE
_("通过房间：{STR_VAR_2}"); //TODO 汉化
#else
_("Rooms cleared: {STR_VAR_2}");
#endif

ALIGNED(4) const u8 gText_FrontierFacilityKOsStreak[] = 
#ifdef CHINESE
_("连续击败：{STR_VAR_2}"); //TODO 汉化
#else
_("KOs in a row: {STR_VAR_2}");
#endif

ALIGNED(4) const u8 gText_FrontierFacilityFloorsCleared[] = 
#ifdef CHINESE
_("通过楼层：{STR_VAR_2}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}慢"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}中"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}快"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}开"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}关"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}接力制"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}淘汰制"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}单声道"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}立体声"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}样式"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR GREEN}{SHADOW LIGHT_GREEN}普通"); //TODO 汉化
#else
...
#ifdef CHINESE
_("玩家：{CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}\n\n此证书证明\n你已经成功完成了\n你的{STR_VAR_1}口袋领航员\n\n{CLEAR_TO 0x42}{COLOR RED}{SHADOW LIGHT_RED}GAME FREAK"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{COLOR RED}{SHADOW LIGHT_RED}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("有宝可梦上钩了！{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("什么也没有……{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("逃走了……{PAUSE_UNTIL_PRESS}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}送到了{STR_VAR_3}。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("[方向空]移动 {A_BUTTON}确认 {B_BUTTON}返回"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WonderCards[] = 
#ifdef CHINESE
_("神秘卡片"); //TODO 汉化
#else
_("WONDER CARDS");
...
ALIGNED(4) const u8 gText_WonderNews[] = 
#ifdef CHINESE
_("神秘新闻"); //TODO 汉化
#else
_("WONDER NEWS");
...
ALIGNED(4) const u8 gText_WirelessCommunication[] = 
#ifdef CHINESE
_("无线通信"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_Friend2[] = 
#ifdef CHINESE
_("好友"); //TODO 汉化
#else
_("FRIEND");
...
ALIGNED(4) const u8 gText_Exit3[] = 
#ifdef CHINESE
_("退出"); //TODO 汉化
#else
_("EXIT");
...
ALIGNED(4) const u8 gText_Receive[] = 
#ifdef CHINESE
_("接收"); //TODO 汉化
#else
_("RECEIVE");
...
ALIGNED(4) const u8 gText_VarietyOfEventsImportedWireless[] = 
#ifdef CHINESE
_("各种各样的事件将会通过\n无线通信中载入。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WonderCardsInPossession[] = 
#ifdef CHINESE
_("阅读你拥有的神秘卡片。"); //TODO 汉化
#else
_("Read the WONDER CARDS in your\npossession.");
#endif

ALIGNED(4) const u8 gText_ReadNewsThatArrived[] = 
#ifdef CHINESE
_("阅读最新的新闻。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_ReturnToTitle[] = 
#ifdef CHINESE
_("返回标题画面。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_DontHaveCardNewOneInput[] = 
#ifdef CHINESE
_("你现在没有神秘卡片，\n所以你将会收到一张新的卡片。"); //TODO 汉化
#else
_("You don't have a WONDER CARD,\nso a new CARD will be input.");
#endif

ALIGNED(4) const u8 gText_DontHaveNewsNewOneInput[] = 
#ifdef CHINESE
_("你没有任何神秘新闻，\n所以你将会收到新的新闻。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WhereShouldCardBeAccessed[] = 
#ifdef CHINESE
_("你希望从哪里获取\n神秘卡片？"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WhereShouldNewsBeAccessed[] = 
#ifdef CHINESE
_("你希望在哪里察看\n神秘新闻？"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_CommunicationStandbyBButtonCancel[] = 
#ifdef CHINESE
_("通信待机中……\nB键：取消"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_Communicating[] = 
#ifdef CHINESE
_("通信中……"); //TODO 汉化
#else
_("Communicating…");
...
ALIGNED(4) const u8 gText_CommunicationCompleted[] = 
#ifdef CHINESE
_("通信完成。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_CommunicationError[] = 
#ifdef CHINESE
_("通信错误。"); //TODO 汉化
#else
_("Communication error.");
...
ALIGNED(4) const u8 gText_CommunicationCanceled[] = 
#ifdef CHINESE
_("通信已被取消。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_ThrowAwayWonderCard[] = 
#ifdef CHINESE
_("丢弃神秘卡片\n并重新领取新的？"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_HaventReceivedCardsGift[] = 
#ifdef CHINESE
_("你还未收到卡片的赠礼\n确认继续？"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WonderCardReceivedFrom[] = 
#ifdef CHINESE
_("从{STR_VAR_1}处收到了一张\n神秘卡片。"); //TODO 汉化
#else
_("A WONDER CARD has been received\nfrom {STR_VAR_1}.");
#endif

ALIGNED(4) const u8 gText_WonderNewsReceivedFrom[] = 
#ifdef CHINESE
_("从{STR_VAR_1}处收到了一条\n神秘新闻。"); //TODO 汉化
#else
_("A WONDER NEWS item has been\nreceived from {STR_VAR_1}.");
#endif

ALIGNED(4) const u8 gText_WonderCardReceived[] = 
#ifdef CHINESE
_("已收到了新的神秘卡片"); //TODO 汉化
#else
_("A new WONDER CARD has been\nreceived.");
#endif

ALIGNED(4) const u8 gText_WonderNewsReceived[] = 
#ifdef CHINESE
_("已收到了新的神秘新闻"); //TODO 汉化
#else
_("A new WONDER NEWS item has been\nreceived.");
#endif

ALIGNED(4) const u8 gText_NewStampReceived[] = 
#ifdef CHINESE
_("已收到了新的印章。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_NewTrainerReceived[] = 
#ifdef CHINESE
_("新的训练师已经到达。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_AlreadyHadCard[] = 
#ifdef CHINESE
_("你已经拥有那张神秘卡片。"); //TODO 汉化
#else
_("You already had that\nWONDER CARD.");
#endif

ALIGNED(4) const u8 gText_AlreadyHadNews[] = 
#ifdef CHINESE
_("你已经拥有那条神秘新闻。"); //TODO 汉化
#else
_("You already had that\nWONDER NEWS item.");
#endif

ALIGNED(4) const u8 gText_AlreadyHadStamp[] = 
#ifdef CHINESE
_("你已经拥有那个印章。"); //TODO 汉化
#else
_("You already had that\nSTAMP.");
...
ALIGNED(4) const u8 gText_NoMoreRoomForStamps[] = 
#ifdef CHINESE
_("没有增加印章的空间了。"); //TODO 汉化
#else
_("There's no more room for adding\nSTAMPS.");
#endif

ALIGNED(4) const u8 gText_RecordUploadedViaWireless[] = 
#ifdef CHINESE
_("你的记录已用无线通信更新。"); //TODO 汉化
#else
_("Your record has been uploaded via\nWIRELESS COMMUNICATION.");
#endif

ALIGNED(4) const u8 gText_CantAcceptCardFromTrainer[] = 
#ifdef CHINESE
_("你不能从这个训练师处接收\n神秘卡片。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_CantAcceptNewsFromTrainer[] = 
#ifdef CHINESE
_("你不能从这个训练师处接收\n神秘新闻。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_NothingSentOver[] = 
#ifdef CHINESE
_("什么也没发生……"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WhatToDoWithCards[] = 
#ifdef CHINESE
_("你想用神秘卡片做什么？"); //TODO 汉化
#else
_("What would you like to do\nwith the WONDER CARDS?");
#endif

ALIGNED(4) const u8 gText_WhatToDoWithNews[] = 
#ifdef CHINESE
_("你想用神秘新闻做什么？"); //TODO 汉化
#else
_("What would you like to do\nwith the WONDER NEWS?");
#endif

ALIGNED(4) const u8 gText_SendingWonderCard[] = 
#ifdef CHINESE
_("正在发送你的神秘卡片……"); //TODO 汉化
#else
_("Sending your WONDER CARD…");
#endif

ALIGNED(4) const u8 gText_SendingWonderNews[] = 
#ifdef CHINESE
_("正在发送你的神秘新闻……"); //TODO 汉化
#else
_("Sending your WONDER NEWS item…");
#endif

ALIGNED(4) const u8 gText_WonderCardSentTo[] = 
#ifdef CHINESE
_("你的神秘卡片已发送给{STR_VAR_1}。"); //TODO 汉化
#else
_("Your WONDER CARD has been sent\nto {STR_VAR_1}.");
#endif

ALIGNED(4) const u8 gText_WonderNewsSentTo[] = 
#ifdef CHINESE
_("你的神秘新闻已发送给{STR_VAR_1}。"); //TODO 汉化
#else
_("Your WONDER NEWS item has been\nsent to {STR_VAR_1}.");
#endif

ALIGNED(4) const u8 gText_StampSentTo[] = 
#ifdef CHINESE
_("一个印章已发送给{STR_VAR_1}。"); //TODO 汉化
#else
_("A STAMP has been sent to {STR_VAR_1}.");
#endif

ALIGNED(4) const u8 gText_GiftSentTo[] = 
#ifdef CHINESE
_("一份礼物也发送给{STR_VAR_1}。"); //TODO 汉化
#else
_("A GIFT has been sent to {STR_VAR_1}.");
#endif

ALIGNED(4) const u8 gText_OtherTrainerHasCard[] = 
#ifdef CHINESE
_("对方训练师已有同样的神秘卡片。"); //TODO 汉化
#else
_("The other TRAINER has the same\nWONDER CARD already.");
#endif

ALIGNED(4) const u8 gText_OtherTrainerHasNews[] = 
#ifdef CHINESE
_("对方训练师已有同样的神秘新闻。"); //TODO 汉化
#else
_("The other TRAINER has the same\nWONDER NEWS already.");
#endif

ALIGNED(4) const u8 gText_OtherTrainerHasStamp[] = 
#ifdef CHINESE
_("对方训练师已有同样的印章。"); //TODO 汉化
#else
_("The other TRAINER has the same\nSTAMP already.");
#endif

ALIGNED(4) const u8 gText_OtherTrainerCanceled[] = 
#ifdef CHINESE
_("对方训练师取消了通信。"); //TODO 汉化
#else
_("The other TRAINER canceled\ncommunication.");
#endif

ALIGNED(4) const u8 gText_CantSendGiftToTrainer[] = 
#ifdef CHINESE
_("你不能将神秘礼物送给这个训练师。"); //TODO 汉化
#else
_("You can't send a MYSTERY GIFT to\nthis TRAINER.");
#endif

ALIGNED(4) const u8 gText_IfThrowAwayCardEventWontHappen[] = 
#ifdef CHINESE
_("如果丢弃卡片，\n其中的事件将不会发生。可以吗？"); //TODO 汉化
#else
_("If you throw away the CARD,\nits event won't happen. Okay?");
#endif

ALIGNED(4) const u8 gText_OkayToDiscardNews[] = 
#ifdef CHINESE
_("删除这条新闻可以吗？"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_HaventReceivedGiftOkayToDiscard[] = 
#ifdef CHINESE
_("你还未收到礼物，真的确定删除吗？"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WonderCardThrownAway[] = 
#ifdef CHINESE
_("丢弃了神秘卡片。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_WonderNewsThrownAway[] = 
#ifdef CHINESE
_("删除了神秘新闻。"); //TODO 汉化
#else
...
ALIGNED(4) const u8 gText_PickOKExit[] = 
#ifdef CHINESE
_("{DPAD_UPDOWN}选择 {A_BUTTON}确认 {B_BUTTON}退出"); //TODO 汉化
#else
_("{DPAD_UPDOWN}PICK {A_BUTTON}OK {B_BUTTON}EXIT");
#endif

ALIGNED(4) const u8 gText_PickOKCancel[] = 
#ifdef CHINESE
_("{DPAD_UPDOWN}选择 {A_BUTTON}确认 {B_BUTTON}取消"); //TODO 汉化
#else
...
#ifdef CHINESE
_("总战绩 胜：{STR_VAR_1} 负：{STR_VAR_2} 平：{STR_VAR_3}"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{CLEAR_TO 0x53}胜{CLEAR_TO 0x80}负{CLEAR_TO 0xB0}平"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1} 分{STR_VAR_2}.{STR_VAR_3} 秒。"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{PAUSE 32}1，{PAUSE 15}2，{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}砰！\p"); //TODO 汉化
#else
...
#ifdef CHINESE
_("{STR_VAR_1}忘了{STR_VAR_3}。\p……\p{STR_VAR_1}学会了{STR_VAR_2}。"); //TODO 汉化
#else
